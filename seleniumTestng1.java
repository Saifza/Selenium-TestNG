...
public class seleniumTestng1 {
	...
	public void selectTesting() throws InterruptedException {
		...
		JavascriptExecutor js = (JavascriptExecutor) driver;
		js.executeScript("arguments[0].setAttribute('style', 'background: tomato; border: 5px steelblue;');",
				carselect);
		...
		// border: 5px steelblue;');", carselect);
	...
	public void mousehoverTesting2() throws InterruptedException {
		...
		System.out.println(driver.findElement(By.xpath("//table[@id=\"product\"]//tr[2]//td[3]")).getText());
		AssertJUnit.assertEquals(driver.findElement(By.xpath("//table[@id=\"product\"]//tr[2]//td[3]")).getText(),
				tableval);
		...
		driver.findElement(By.xpath(
				"//div[@class=\"navbar navbar-fedora navbar-fixed-top is-at-top bs-docs-nav is-not-signed-in\"][@id=\"navbar\"]/div/div/button"))
				.click();
